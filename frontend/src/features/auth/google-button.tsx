  ...
  return (
    <div className="space-y-1.5">
      <Button
        ...
        variant="ghost"
        block
        className="h-11 gap-2.5 rounded-md bg-primary-soft text-[0.8125rem] font-semibold text-primary hover:bg-primary-soft/70"
        disabled={!available}
...
export function OrDivider({ label }: { label?: string }) {
  const { t } = useTranslation();
  return (
    <div className="my-4 flex items-center gap-3 text-[0.75rem] font-medium text-muted-foreground" role="separator">
